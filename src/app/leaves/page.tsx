                        ...
                        <form action={async (formData) => {
                            ...
                            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="startDate" id="startDate" required className="block h-10 w-full rounded-md border border-input bg-background pl-3 pr-10 py-2 text-sm text-foreground ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ colorScheme: 'light' }} />
                                </div>
                                <div>
                                    <label className="text-sm font-medium mb-1.5 block text-foreground" htmlFor="endDate">End Date</label>
                                    <input type="date" name="endDate" id="endDate" required className="block h-10 w-full rounded-md border border-input bg-background pl-3 pr-10 py-2 text-sm text-foreground ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2" style={{ colorScheme: 'light' }} />
                                </div>
                            </div>
                            <div>
